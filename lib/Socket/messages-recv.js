...
const makeMessagesRecvSocket = (config) => {
    ...
    const handleMessage = withAck(async (node) => {
        ...
        let response;
        // Send ACK immediately for unavailable messages (optimization from second file)
    ...
    const handleBadAck = async ({ attrs }) => {
        ...
        // WARNING: REFRAIN FROM ENABLING THIS FOR NOW. IT WILL CAUSE A LOOP AND DUPLICATE MESSAGES
